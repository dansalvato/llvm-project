...
; CHECK-NEXT:    cmpi.b #0, %d3
; CHECK-NEXT:    beq .LBB18_5
; CHECK-NEXT:  .LBB18_4:
; CHECK-NEXT:    lsr.l %d2, %d0
; CHECK-NEXT:    bra .LBB18_6
; CHECK-NEXT:  .LBB18_2:
; CHECK-NEXT:    move.l %d0, %d1
; CHECK-NEXT:    lsr.l %d4, %d1
; CHECK-NEXT:    cmpi.b #0, %d3
; CHECK-NEXT:    bne .LBB18_4
; CHECK-NEXT:  .LBB18_5:
; CHECK-NEXT:    moveq #0, %d0
; CHECK-NEXT:  .LBB18_6:
...
; CHECK-NEXT:    movem.l %d2-%d5, (0,%sp) ; 20-byte Folded Spill
; CHECK-NEXT:    move.l (20,%sp), %d1
...
; CHECK-NEXT:    cmpi.b #0, %d4
; CHECK-NEXT:    beq .LBB19_5
; CHECK-NEXT:  .LBB19_4:
; CHECK-NEXT:    move.l (24,%sp), %d3
; CHECK-NEXT:    lsr.l %d2, %d3
; CHECK-NEXT:    eori.l #31, %d2
; CHECK-NEXT:    lsl.l #1, %d1
; CHECK-NEXT:    lsl.l %d2, %d1
; CHECK-NEXT:    or.l %d3, %d1
; CHECK-NEXT:    bra .LBB19_6
; CHECK-NEXT:  .LBB19_2:
; CHECK-NEXT:    moveq #31, %d5
; CHECK-NEXT:    move.l %d1, %d0
; CHECK-NEXT:    asr.l %d5, %d0
; CHECK-NEXT:    cmpi.b #0, %d4
; CHECK-NEXT:    bne .LBB19_4
; CHECK-NEXT:  .LBB19_5:
; CHECK-NEXT:    asr.l %d3, %d1
; CHECK-NEXT:  .LBB19_6:
; CHECK-NEXT:    movem.l (0,%sp), %d2-%d5 ; 20-byte Folded Reload
...
; CHECK-NEXT:    eori.l #31, %d0
; CHECK-NEXT:    move.l %d1, %d4
; CHECK-NEXT:    lsr.l #1, %d4
; CHECK-NEXT:    lsr.l %d0, %d4
; CHECK-NEXT:    move.l (16,%sp), %d0
; CHECK-NEXT:    lsl.l %d2, %d0
; CHECK-NEXT:    or.l %d4, %d0
; CHECK-NEXT:    cmpi.b #0, %d3
; CHECK-NEXT:    beq .LBB20_5
; CHECK-NEXT:  .LBB20_4:
; CHECK-NEXT:    lsl.l %d2, %d1
; CHECK-NEXT:    bra .LBB20_6
; CHECK-NEXT:  .LBB20_2:
; CHECK-NEXT:    move.l %d1, %d0
; CHECK-NEXT:    lsl.l %d4, %d0
; CHECK-NEXT:    cmpi.b #0, %d3
; CHECK-NEXT:    bne .LBB20_4
; CHECK-NEXT:  .LBB20_5:
