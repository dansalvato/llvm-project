...
; ATOMIC-PIC-NEXT:    seq %d3
; ATOMIC-PIC-NEXT:    move.b %d0, %d2
; ATOMIC-PIC-NEXT:    cmpi.b #0, %d3
...
; ATOMIC-NEXT:  .LBB6_4: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB6_1 Depth=1
; ATOMIC-NEXT:    move.l %d2, %d0
; ATOMIC-NEXT:    cas.l %d0, %d3, (%a0)
; ATOMIC-NEXT:    cmp.l %d2, %d0
...
; ATOMIC-NEXT:    move.l %d0, %d2
; ATOMIC-NEXT:    cmpi.b #0, %d3
; ATOMIC-NEXT:    beq .LBB6_5
; ATOMIC-NEXT:  .LBB6_1: ; %atomicrmw.start
; ATOMIC-NEXT:    ; =>This Inner Loop Header: Depth=1
; ATOMIC-NEXT:    cmp.l %d1, %d2
; ATOMIC-NEXT:    bgt .LBB6_3
; ATOMIC-NEXT:  ; %bb.2: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB6_1 Depth=1
; ATOMIC-NEXT:    move.l %d2, %d3
; ATOMIC-NEXT:    bra .LBB6_4
; ATOMIC-NEXT:  .LBB6_5: ; %atomicrmw.end
; ATOMIC-NEXT:    movem.l (0,%sp), %d2-%d3 ; 12-byte Folded Reload
; ATOMIC-NEXT:    adda.l #8, %sp
; ATOMIC-NEXT:    rts
;
...
; ATOMIC-PIC-NEXT:  .LBB6_4: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB6_1 Depth=1
; ATOMIC-PIC-NEXT:    move.l %d2, %d0
; ATOMIC-PIC-NEXT:    cas.l %d0, %d3, (%a0)
; ATOMIC-PIC-NEXT:    cmp.l %d2, %d0
...
; ATOMIC-PIC-NEXT:    move.l %d0, %d2
; ATOMIC-PIC-NEXT:    cmpi.b #0, %d3
; ATOMIC-PIC-NEXT:    beq .LBB6_5
; ATOMIC-PIC-NEXT:  .LBB6_1: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; =>This Inner Loop Header: Depth=1
; ATOMIC-PIC-NEXT:    cmp.l %d1, %d2
; ATOMIC-PIC-NEXT:    bgt .LBB6_3
; ATOMIC-PIC-NEXT:  ; %bb.2: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB6_1 Depth=1
; ATOMIC-PIC-NEXT:    move.l %d2, %d3
; ATOMIC-PIC-NEXT:    bra .LBB6_4
; ATOMIC-PIC-NEXT:  .LBB6_5: ; %atomicrmw.end
; ATOMIC-PIC-NEXT:    movem.l (0,%sp), %d2-%d3 ; 12-byte Folded Reload
; ATOMIC-PIC-NEXT:    adda.l #8, %sp
; ATOMIC-PIC-NEXT:    rts
...
; NO-ATOMIC-000-NEXT:    movem.l %d2-%d5, (36,%sp) ; 20-byte Folded Spill
...
; NO-ATOMIC-000-NEXT:  .LBB7_5: ; %atomicrmw.start
; NO-ATOMIC-000-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-000-NEXT:    move.l %d4, %a0
; NO-ATOMIC-000-NEXT:  .LBB7_6: ; %atomicrmw.start
; NO-ATOMIC-000-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-000-NEXT:    move.l %d1, (28,%sp)
; NO-ATOMIC-000-NEXT:    lea (24,%sp), %a1
; NO-ATOMIC-000-NEXT:    move.l %a1, (4,%sp)
; NO-ATOMIC-000-NEXT:    move.l %d3, (%sp)
; NO-ATOMIC-000-NEXT:    move.l %a0, (12,%sp)
; NO-ATOMIC-000-NEXT:    move.l %d0, (8,%sp)
...
; NO-ATOMIC-000-NEXT:    scs %d2
; NO-ATOMIC-000-NEXT:    add.b #-1, %d2
; NO-ATOMIC-000-NEXT:    move.l %d5, %d2
; NO-ATOMIC-000-NEXT:    subx.l %d0, %d2
; NO-ATOMIC-000-NEXT:    slt %d2
; NO-ATOMIC-000-NEXT:    bge .LBB7_3
; NO-ATOMIC-000-NEXT:  ; %bb.2: ; %atomicrmw.start
; NO-ATOMIC-000-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-000-NEXT:    cmpi.b #0, %d2
; NO-ATOMIC-000-NEXT:    bne .LBB7_4
; NO-ATOMIC-000-NEXT:    bra .LBB7_5
; NO-ATOMIC-000-NEXT:  .LBB7_3: ; %atomicrmw.start
; NO-ATOMIC-000-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-000-NEXT:    move.l %d5, %d0
; NO-ATOMIC-000-NEXT:    cmpi.b #0, %d2
; NO-ATOMIC-000-NEXT:    beq .LBB7_5
; NO-ATOMIC-000-NEXT:  .LBB7_4: ; %atomicrmw.start
; NO-ATOMIC-000-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-000-NEXT:    move.l %d1, %a0
; NO-ATOMIC-000-NEXT:    bra .LBB7_6
; NO-ATOMIC-000-NEXT:  .LBB7_7: ; %atomicrmw.end
; NO-ATOMIC-000-NEXT:    movem.l (36,%sp), %d2-%d5 ; 20-byte Folded Reload
...
; NO-ATOMIC-010-NEXT:    movem.l %d2-%d5, (36,%sp) ; 20-byte Folded Spill
...
; NO-ATOMIC-010-NEXT:  .LBB7_5: ; %atomicrmw.start
; NO-ATOMIC-010-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-010-NEXT:    move.l %d4, %a0
; NO-ATOMIC-010-NEXT:  .LBB7_6: ; %atomicrmw.start
; NO-ATOMIC-010-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-010-NEXT:    move.l %d1, (28,%sp)
; NO-ATOMIC-010-NEXT:    lea (24,%sp), %a1
; NO-ATOMIC-010-NEXT:    move.l %a1, (4,%sp)
; NO-ATOMIC-010-NEXT:    move.l %d3, (%sp)
; NO-ATOMIC-010-NEXT:    move.l %a0, (12,%sp)
; NO-ATOMIC-010-NEXT:    move.l %d0, (8,%sp)
...
; NO-ATOMIC-010-NEXT:    scs %d2
; NO-ATOMIC-010-NEXT:    add.b #-1, %d2
; NO-ATOMIC-010-NEXT:    move.l %d5, %d2
; NO-ATOMIC-010-NEXT:    subx.l %d0, %d2
; NO-ATOMIC-010-NEXT:    slt %d2
; NO-ATOMIC-010-NEXT:    bge .LBB7_3
; NO-ATOMIC-010-NEXT:  ; %bb.2: ; %atomicrmw.start
; NO-ATOMIC-010-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-010-NEXT:    cmpi.b #0, %d2
; NO-ATOMIC-010-NEXT:    bne .LBB7_4
; NO-ATOMIC-010-NEXT:    bra .LBB7_5
; NO-ATOMIC-010-NEXT:  .LBB7_3: ; %atomicrmw.start
; NO-ATOMIC-010-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-010-NEXT:    move.l %d5, %d0
; NO-ATOMIC-010-NEXT:    cmpi.b #0, %d2
; NO-ATOMIC-010-NEXT:    beq .LBB7_5
; NO-ATOMIC-010-NEXT:  .LBB7_4: ; %atomicrmw.start
; NO-ATOMIC-010-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-010-NEXT:    move.l %d1, %a0
; NO-ATOMIC-010-NEXT:    bra .LBB7_6
; NO-ATOMIC-010-NEXT:  .LBB7_7: ; %atomicrmw.end
; NO-ATOMIC-010-NEXT:    movem.l (36,%sp), %d2-%d5 ; 20-byte Folded Reload
...
; NO-ATOMIC-PIC-000-NEXT:    movem.l %d2-%d5, (36,%sp) ; 20-byte Folded Spill
...
; NO-ATOMIC-PIC-000-NEXT:  .LBB7_5: ; %atomicrmw.start
; NO-ATOMIC-PIC-000-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-PIC-000-NEXT:    move.l %d4, %a0
; NO-ATOMIC-PIC-000-NEXT:  .LBB7_6: ; %atomicrmw.start
; NO-ATOMIC-PIC-000-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-PIC-000-NEXT:    move.l %d1, (28,%sp)
; NO-ATOMIC-PIC-000-NEXT:    lea (24,%sp), %a1
; NO-ATOMIC-PIC-000-NEXT:    move.l %a1, (4,%sp)
; NO-ATOMIC-PIC-000-NEXT:    move.l %d3, (%sp)
; NO-ATOMIC-PIC-000-NEXT:    move.l %a0, (12,%sp)
; NO-ATOMIC-PIC-000-NEXT:    move.l %d0, (8,%sp)
...
; NO-ATOMIC-PIC-000-NEXT:    bne .LBB7_7
...
; NO-ATOMIC-PIC-000-NEXT:    scs %d2
; NO-ATOMIC-PIC-000-NEXT:    add.b #-1, %d2
; NO-ATOMIC-PIC-000-NEXT:    move.l %d5, %d2
; NO-ATOMIC-PIC-000-NEXT:    subx.l %d0, %d2
; NO-ATOMIC-PIC-000-NEXT:    slt %d2
; NO-ATOMIC-PIC-000-NEXT:    bge .LBB7_3
; NO-ATOMIC-PIC-000-NEXT:  ; %bb.2: ; %atomicrmw.start
; NO-ATOMIC-PIC-000-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-PIC-000-NEXT:    cmpi.b #0, %d2
; NO-ATOMIC-PIC-000-NEXT:    bne .LBB7_4
; NO-ATOMIC-PIC-000-NEXT:    bra .LBB7_5
; NO-ATOMIC-PIC-000-NEXT:  .LBB7_3: ; %atomicrmw.start
; NO-ATOMIC-PIC-000-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-PIC-000-NEXT:    move.l %d5, %d0
; NO-ATOMIC-PIC-000-NEXT:    cmpi.b #0, %d2
; NO-ATOMIC-PIC-000-NEXT:    beq .LBB7_5
; NO-ATOMIC-PIC-000-NEXT:  .LBB7_4: ; %atomicrmw.start
; NO-ATOMIC-PIC-000-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-PIC-000-NEXT:    move.l %d1, %a0
; NO-ATOMIC-PIC-000-NEXT:    bra .LBB7_6
; NO-ATOMIC-PIC-000-NEXT:  .LBB7_7: ; %atomicrmw.end
; NO-ATOMIC-PIC-000-NEXT:    movem.l (36,%sp), %d2-%d5 ; 20-byte Folded Reload
...
; NO-ATOMIC-PIC-010-NEXT:    movem.l %d2-%d5, (36,%sp) ; 20-byte Folded Spill
...
; NO-ATOMIC-PIC-010-NEXT:  .LBB7_5: ; %atomicrmw.start
; NO-ATOMIC-PIC-010-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-PIC-010-NEXT:    move.l %d4, %a0
; NO-ATOMIC-PIC-010-NEXT:  .LBB7_6: ; %atomicrmw.start
; NO-ATOMIC-PIC-010-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-PIC-010-NEXT:    move.l %d1, (28,%sp)
; NO-ATOMIC-PIC-010-NEXT:    lea (24,%sp), %a1
; NO-ATOMIC-PIC-010-NEXT:    move.l %a1, (4,%sp)
; NO-ATOMIC-PIC-010-NEXT:    move.l %d3, (%sp)
; NO-ATOMIC-PIC-010-NEXT:    move.l %a0, (12,%sp)
; NO-ATOMIC-PIC-010-NEXT:    move.l %d0, (8,%sp)
...
; NO-ATOMIC-PIC-010-NEXT:    bne .LBB7_7
...
; NO-ATOMIC-PIC-010-NEXT:    scs %d2
; NO-ATOMIC-PIC-010-NEXT:    add.b #-1, %d2
; NO-ATOMIC-PIC-010-NEXT:    move.l %d5, %d2
; NO-ATOMIC-PIC-010-NEXT:    subx.l %d0, %d2
; NO-ATOMIC-PIC-010-NEXT:    slt %d2
; NO-ATOMIC-PIC-010-NEXT:    bge .LBB7_3
; NO-ATOMIC-PIC-010-NEXT:  ; %bb.2: ; %atomicrmw.start
; NO-ATOMIC-PIC-010-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-PIC-010-NEXT:    cmpi.b #0, %d2
; NO-ATOMIC-PIC-010-NEXT:    bne .LBB7_4
; NO-ATOMIC-PIC-010-NEXT:    bra .LBB7_5
; NO-ATOMIC-PIC-010-NEXT:  .LBB7_3: ; %atomicrmw.start
; NO-ATOMIC-PIC-010-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-PIC-010-NEXT:    move.l %d5, %d0
; NO-ATOMIC-PIC-010-NEXT:    cmpi.b #0, %d2
; NO-ATOMIC-PIC-010-NEXT:    beq .LBB7_5
; NO-ATOMIC-PIC-010-NEXT:  .LBB7_4: ; %atomicrmw.start
; NO-ATOMIC-PIC-010-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; NO-ATOMIC-PIC-010-NEXT:    move.l %d1, %a0
; NO-ATOMIC-PIC-010-NEXT:    bra .LBB7_6
; NO-ATOMIC-PIC-010-NEXT:  .LBB7_7: ; %atomicrmw.end
; NO-ATOMIC-PIC-010-NEXT:    movem.l (36,%sp), %d2-%d5 ; 20-byte Folded Reload
...
; ATOMIC-NEXT:    movem.l %d2-%d5, (36,%sp) ; 20-byte Folded Spill
...
; ATOMIC-NEXT:  .LBB7_5: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; ATOMIC-NEXT:    move.l %d4, %a0
; ATOMIC-NEXT:  .LBB7_6: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; ATOMIC-NEXT:    move.l %d1, (28,%sp)
; ATOMIC-NEXT:    lea (24,%sp), %a1
; ATOMIC-NEXT:    move.l %a1, (4,%sp)
; ATOMIC-NEXT:    move.l %d3, (%sp)
; ATOMIC-NEXT:    move.l %a0, (12,%sp)
; ATOMIC-NEXT:    move.l %d0, (8,%sp)
...
; ATOMIC-NEXT:    slt %d2
; ATOMIC-NEXT:    bge .LBB7_3
; ATOMIC-NEXT:  ; %bb.2: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; ATOMIC-NEXT:    cmpi.b #0, %d2
; ATOMIC-NEXT:    bne .LBB7_4
; ATOMIC-NEXT:    bra .LBB7_5
; ATOMIC-NEXT:  .LBB7_3: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; ATOMIC-NEXT:    move.l %d5, %d0
; ATOMIC-NEXT:    cmpi.b #0, %d2
; ATOMIC-NEXT:    beq .LBB7_5
; ATOMIC-NEXT:  .LBB7_4: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; ATOMIC-NEXT:    move.l %d1, %a0
; ATOMIC-NEXT:    bra .LBB7_6
; ATOMIC-NEXT:  .LBB7_7: ; %atomicrmw.end
; ATOMIC-NEXT:    movem.l (36,%sp), %d2-%d5 ; 20-byte Folded Reload
...
; ATOMIC-PIC-NEXT:    movem.l %d2-%d5, (36,%sp) ; 20-byte Folded Spill
...
; ATOMIC-PIC-NEXT:  .LBB7_5: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; ATOMIC-PIC-NEXT:    move.l %d4, %a0
; ATOMIC-PIC-NEXT:  .LBB7_6: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; ATOMIC-PIC-NEXT:    move.l %d1, (28,%sp)
; ATOMIC-PIC-NEXT:    lea (24,%sp), %a1
; ATOMIC-PIC-NEXT:    move.l %a1, (4,%sp)
; ATOMIC-PIC-NEXT:    move.l %d3, (%sp)
; ATOMIC-PIC-NEXT:    move.l %a0, (12,%sp)
; ATOMIC-PIC-NEXT:    move.l %d0, (8,%sp)
...
; ATOMIC-PIC-NEXT:    scs %d2
; ATOMIC-PIC-NEXT:    add.b #-1, %d2
; ATOMIC-PIC-NEXT:    move.l %d5, %d2
; ATOMIC-PIC-NEXT:    subx.l %d0, %d2
; ATOMIC-PIC-NEXT:    slt %d2
; ATOMIC-PIC-NEXT:    bge .LBB7_3
; ATOMIC-PIC-NEXT:  ; %bb.2: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; ATOMIC-PIC-NEXT:    cmpi.b #0, %d2
; ATOMIC-PIC-NEXT:    bne .LBB7_4
; ATOMIC-PIC-NEXT:    bra .LBB7_5
; ATOMIC-PIC-NEXT:  .LBB7_3: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; ATOMIC-PIC-NEXT:    move.l %d5, %d0
; ATOMIC-PIC-NEXT:    cmpi.b #0, %d2
; ATOMIC-PIC-NEXT:    beq .LBB7_5
; ATOMIC-PIC-NEXT:  .LBB7_4: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB7_1 Depth=1
; ATOMIC-PIC-NEXT:    move.l %d1, %a0
; ATOMIC-PIC-NEXT:    bra .LBB7_6
; ATOMIC-PIC-NEXT:  .LBB7_7: ; %atomicrmw.end
; ATOMIC-PIC-NEXT:    movem.l (36,%sp), %d2-%d5 ; 20-byte Folded Reload
...
; ATOMIC-NEXT:  .LBB8_4: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB8_1 Depth=1
; ATOMIC-NEXT:    move.b %d2, %d0
; ATOMIC-NEXT:    cas.b %d0, %d3, (%a0)
; ATOMIC-NEXT:    cmp.b %d2, %d0
...
; ATOMIC-NEXT:    move.b %d0, %d2
; ATOMIC-NEXT:    cmpi.b #0, %d3
; ATOMIC-NEXT:    beq .LBB8_5
; ATOMIC-NEXT:  .LBB8_1: ; %atomicrmw.start
; ATOMIC-NEXT:    ; =>This Inner Loop Header: Depth=1
; ATOMIC-NEXT:    cmp.b %d1, %d2
; ATOMIC-NEXT:    bhi .LBB8_3
; ATOMIC-NEXT:  ; %bb.2: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB8_1 Depth=1
; ATOMIC-NEXT:    move.b %d2, %d3
; ATOMIC-NEXT:    bra .LBB8_4
; ATOMIC-NEXT:  .LBB8_5: ; %atomicrmw.end
; ATOMIC-NEXT:    movem.l (0,%sp), %d2-%d3 ; 12-byte Folded Reload
; ATOMIC-NEXT:    adda.l #8, %sp
; ATOMIC-NEXT:    rts
;
...
; ATOMIC-PIC-NEXT:  .LBB8_4: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB8_1 Depth=1
; ATOMIC-PIC-NEXT:    move.b %d2, %d0
; ATOMIC-PIC-NEXT:    cas.b %d0, %d3, (%a0)
; ATOMIC-PIC-NEXT:    cmp.b %d2, %d0
...
; ATOMIC-PIC-NEXT:    move.b %d0, %d2
; ATOMIC-PIC-NEXT:    cmpi.b #0, %d3
; ATOMIC-PIC-NEXT:    beq .LBB8_5
; ATOMIC-PIC-NEXT:  .LBB8_1: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; =>This Inner Loop Header: Depth=1
; ATOMIC-PIC-NEXT:    cmp.b %d1, %d2
; ATOMIC-PIC-NEXT:    bhi .LBB8_3
; ATOMIC-PIC-NEXT:  ; %bb.2: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB8_1 Depth=1
; ATOMIC-PIC-NEXT:    move.b %d2, %d3
; ATOMIC-PIC-NEXT:    bra .LBB8_4
; ATOMIC-PIC-NEXT:  .LBB8_5: ; %atomicrmw.end
; ATOMIC-PIC-NEXT:    movem.l (0,%sp), %d2-%d3 ; 12-byte Folded Reload
; ATOMIC-PIC-NEXT:    adda.l #8, %sp
; ATOMIC-PIC-NEXT:    rts
...
; ATOMIC-NEXT:  .LBB9_4: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB9_1 Depth=1
; ATOMIC-NEXT:    move.w %d2, %d0
; ATOMIC-NEXT:    cas.w %d0, %d3, (%a0)
; ATOMIC-NEXT:    cmp.w %d2, %d0
...
; ATOMIC-NEXT:    move.w %d0, %d2
; ATOMIC-NEXT:    cmpi.b #0, %d3
; ATOMIC-NEXT:    beq .LBB9_5
; ATOMIC-NEXT:  .LBB9_1: ; %atomicrmw.start
; ATOMIC-NEXT:    ; =>This Inner Loop Header: Depth=1
; ATOMIC-NEXT:    cmp.w %d1, %d2
; ATOMIC-NEXT:    bls .LBB9_3
; ATOMIC-NEXT:  ; %bb.2: ; %atomicrmw.start
; ATOMIC-NEXT:    ; in Loop: Header=BB9_1 Depth=1
; ATOMIC-NEXT:    move.w %d2, %d3
; ATOMIC-NEXT:    bra .LBB9_4
; ATOMIC-NEXT:  .LBB9_5: ; %atomicrmw.end
; ATOMIC-NEXT:    movem.l (0,%sp), %d2-%d3 ; 12-byte Folded Reload
; ATOMIC-NEXT:    adda.l #8, %sp
; ATOMIC-NEXT:    rts
;
...
; ATOMIC-PIC-NEXT:  .LBB9_4: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB9_1 Depth=1
; ATOMIC-PIC-NEXT:    move.w %d2, %d0
; ATOMIC-PIC-NEXT:    cas.w %d0, %d3, (%a0)
; ATOMIC-PIC-NEXT:    cmp.w %d2, %d0
...
; ATOMIC-PIC-NEXT:    move.w %d0, %d2
; ATOMIC-PIC-NEXT:    cmpi.b #0, %d3
; ATOMIC-PIC-NEXT:    beq .LBB9_5
; ATOMIC-PIC-NEXT:  .LBB9_1: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; =>This Inner Loop Header: Depth=1
; ATOMIC-PIC-NEXT:    cmp.w %d1, %d2
; ATOMIC-PIC-NEXT:    bls .LBB9_3
; ATOMIC-PIC-NEXT:  ; %bb.2: ; %atomicrmw.start
; ATOMIC-PIC-NEXT:    ; in Loop: Header=BB9_1 Depth=1
; ATOMIC-PIC-NEXT:    move.w %d2, %d3
; ATOMIC-PIC-NEXT:    bra .LBB9_4
; ATOMIC-PIC-NEXT:  .LBB9_5: ; %atomicrmw.end
; ATOMIC-PIC-NEXT:    movem.l (0,%sp), %d2-%d3 ; 12-byte Folded Reload
; ATOMIC-PIC-NEXT:    adda.l #8, %sp
; ATOMIC-PIC-NEXT:    rts
