...
; CHECK-NEXT:    sub.l #1, %d0
; CHECK-NEXT:    scs %d1
; CHECK-NEXT:    move.l (8,%sp), %d2
; CHECK-NEXT:    moveq #0, %d0
; CHECK-NEXT:    add.b #-1, %d1
; CHECK-NEXT:    subx.l %d0, %d2
; CHECK-NEXT:    slt %d1
